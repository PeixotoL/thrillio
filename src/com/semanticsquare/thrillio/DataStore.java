...
public class DataStore {
	...
	// bookmarks need to be two dimension because one is for type and other for
	// actual bookmark
	...
	private static void loadWebLinks() {
		// BEFORE INPUT/OUTPUT (IO) STREAM
		// first dimension is weblinks and second the first bookmark and so on
		/**
		 * bookmarks[0][0] = BookmarkManager.getInstance().createWebLink(2000, "Taming
		 * Tiger, Part 2",
		 * "http://www.javaworld.com/article/2072759/core-java/taming-tiger--part-2.html",
		 * "http://www.javaworld.com"); bookmarks[0][1] =
		 * BookmarkManager.getInstance().createWebLink(2001, "How do I import a
		 * pre-existing Java project into Eclipse and get up and running?",
		 ...
		 * BookmarkManager.getInstance().createWebLink(2002, "Interface vs Abstract
		 * Class", "http://mindprod.com/jgloss/interfacevsabstract.html",
		 * "http://mindprod.com"); bookmarks[0][3] =
		 * BookmarkManager.getInstance().createWebLink(2003, "NIO tutorial by Greg
		 * Travis", "http://cs.brown.edu/courses/cs161/papers/j-nio-ltr.pdf",
		 * "http://cs.brown.edu"); bookmarks[0][4] =
		 * BookmarkManager.getInstance().createWebLink(2004, "Virtual Hosting and
		 * Tomcat",
	...
	private static void loadMovies() {
		// BEFORE INPUT/OUTPUT (IO) STREAM
		/**
		 * bookmarks[1][0] = BookmarkManager.getInstance().createMovie(3000, "Citizen
		 * Kane", "", 1941, new String[] { "Orson Welles", "Joseph Cotten" }, new
		 ...
		 * Ford" }, MovieGenre.CLASSICS, 8.2); bookmarks[1][2] =
		 ...
		 * 2007, new String[] { "Kaley Cuoco", "Jim Parsons" }, new String[] { "Chuck
		 * Lorre", "Bill Prady" }, MovieGenre.TV_SHOWS, 8.7); bookmarks[1][4] =
		 * BookmarkManager.getInstance().createMovie(3004, "Ikiru", "", 1952, new
		 * String[] { "Takashi Shimura", "Minoru Chiaki" }, new String[] { "Akira
		 * Kurosawa" }, MovieGenre.FOREIGN_MOVIES, 8.4);
		 */
		// AFTER IO
		String[] data = new String[BOOKMARK_COUNT_PER_TYPE];
	...
	private static void loadBooks() {
		 ...
		 * BookmarkManager.getInstance().createBook(4001, "Self-Reliance and Other
		 * Essays", "", 1993, "Dover Publications", new String[] { "Ralph Waldo Emerson"
		 * }, BookGenre.PHILOSOPHY, 4.5); bookmarks[2][2] =
		 ...
		 * bookmarks[2][4] = BookmarkManager.getInstance().createBook(4004, "Effective
		 * Java Programming Language Guide", "", 2007, "Prentice Hall", new String[] {
		 * "Joshua Bloch" }, BookGenre.TECHNICAL, 4.9);
		 */
		// AFTER IO
		String[] data = new String[BOOKMARK_COUNT_PER_TYPE];
